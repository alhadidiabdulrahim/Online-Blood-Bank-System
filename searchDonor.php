    ...
    <body>
        ...
        <main>
            <div class="container justify-content-center form-center">
                <h1 class=" center-text">Search for Donor</h1>
                <hr style="width: 50%; height: 5px; color: red; margin: auto;"><br>
                <div class="col-ms-6 ">
                    <form action="searchDonor.php" method="GET">
                        <div class="form-floating mb-3">
                            <input class="form-control" id="searchDonor" type="text" name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" required/>
                            <label>Search</label>
                        </div>
